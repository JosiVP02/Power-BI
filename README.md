...
raw
Readme · MD
# 📊 Portfolio de Data Analytics — Power BI
 
> Dashboards interactivos construidos con Power BI, DAX y datos reales para resolver problemas de negocio.
 
---
 
## 👤 Sobre mí
 
Estudiante / analista de datos apasionado por convertir datos en decisiones. Este repositorio reúne mis proyectos de Business Intelligence y visualización de datos.
 
---
 
## 🗂️ Proyectos
 
### 1. 🏢 Análisis de Deserción de Empleados — IBM HR
**¿Cuáles empleados tienen mayor riesgo de renunciar?**
 
- 📁 Dataset: IBM HR Analytics (1,470 empleados, 35 variables)
- 🛠️ Herramientas: Power BI, DAX
- 📌 Highlights:
  - Score de riesgo personalizado con 4 factores
  - 194 empleados en riesgo crítico identificados
...
- 💼 [LinkedIn](https://www.linkedin.com/in/josimarvp02/)
